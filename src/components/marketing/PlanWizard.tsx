      ...
      <div className="mb-10 flex items-center justify-center gap-1 sm:gap-2">
        {STEPS.map((label, i) => (
          <div key={label} className="flex items-center gap-1 sm:gap-2">
            <button
              ...
              className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-medium transition-colors ${
                i < step
                  ...
                  : i === step
                  ? "bg-neutral-900 text-white ring-2 ring-neutral-300 ring-offset-2"
            ...
            {i < STEPS.length - 1 && (
              <div className={`h-px w-4 sm:w-8 ${i < step ? "bg-neutral-900" : "bg-neutral-200"}`} />
            )}
          </div>
        ))}
      </div>
      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_220px]">
          ...
          {step === 0 && (
            <div className="animate-in space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">The basics help us shape the right celebration.</p>
              </div>

              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Anniversary milestone</label>
                  <Input value={anniversaryYear} onChange={(e) => setAnniversaryYear(e.target.value)} placeholder="e.g. 10th, 25th, 1st" className="mt-1" />
                </div>
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Celebration window</label>
              ...
              <div>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" checked={datesFlexible} onChange={(e) => setDatesFlexible(e.target.checked)} className="h-4 w-4 rounded border-neutral-300" />
                  <span className="text-sm text-neutral-700">Our dates are flexible</span>
                </label>
                <div className="mt-3 grid gap-4 sm:grid-cols-2">
                  <div>
                    <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Earliest start</label>
                    <Input type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} className="mt-1" />
                  </div>
                  <div>
                    <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Latest end</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Where in South Africa? *</label>
          ...
          {step === 1 && (
            <div className="animate-in space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">What kind of anniversary celebration speaks to you?</p>
              </div>

              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Experience style *</label>
                <div className="mt-2 flex flex-wrap gap-2">
                  {STYLES.map((s) => (
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Luxury tone</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Pace</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Special moments or experiences</label>
          ...
          {step === 2 && (
            <div className="animate-in space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">Practical details that help us plan the right itinerary.</p>
              </div>

              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Trip length</label>
                  <Input value={tripLength} onChange={(e) => setTripLength(e.target.value)} placeholder="e.g. 3 nights, 5–7 nights" className="mt-1" />
                </div>
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Number of travellers</label>
                  <Input value={travellerCount} onChange={(e) => setTravellerCount(e.target.value)} placeholder="e.g. 2, or 2 + 2 children" className="mt-1" />
                </div>
              </div>

              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Departure city</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Budget comfort zone *</label>
                <p className="mt-1 text-xs text-neutral-400">This includes accommodation, experiences, and concierge planning.</p>
          ...
          {step === 3 && (
            <div className="animate-in space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">The details that make it uniquely yours.</p>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Dietary needs or allergies</label>
                ...
                <div>
                  <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Accessibility requirements</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Preferences or requests</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Any surprises you&apos;d like us to arrange?</label>
              ...
              <div>
                <label className="text-xs font-medium text-neutral-500 uppercase tracking-wider">Message to our concierge team</label>
          ...
          {step === 4 && (
            <div className="animate-in space-y-6">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-500">Check the details below, then submit. We&apos;ll be in touch within 24 hours.</p>
              </div>
        ...
        <div className="hidden lg:block">
          <div className="sticky top-24 rounded-xl border border-neutral-200 bg-white p-5 shadow-sm">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-neutral-400">Your Brief</h4>
            <div className="mt-4 space-y-3 text-sm text-neutral-600">
              ...
              {!travelRegions.length && !experienceStyles.length && (
                <p className="text-xs text-neutral-400 italic">Your selections will appear here</p>
              )}
            </div>
          </div>
        </div>
...
function ReviewSection({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="rounded-xl border border-neutral-100 bg-neutral-50/50 p-4">
      <h3 className="text-xs font-semibold uppercase tracking-wider text-neutral-400 mb-3">{label}</h3>
